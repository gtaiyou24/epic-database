...
from listing.domain.model.company import Company, CompanyId, Summary, Address, ContactPoint
...
class CompaniesTableRow(DataBase):
    ...
    def update(self, company: Company) -> None:
        ...
        self.summaries = CompanySummariesTableRow.create(company)
        self.contact_points = CompanyContactPointsTableRow.create(company)
        self.offices = CompanyOfficesTableRow.create(company)
