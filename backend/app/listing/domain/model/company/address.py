...
class Address:
    ...
    def __init__(self, country: str, postal_code: int, prefecture: Prefecture, city: str, street: str):
        assert isinstance(postal_code, int) and len(str(postal_code)) == 7, "郵便番号は7桁の数字を入力してください。"
